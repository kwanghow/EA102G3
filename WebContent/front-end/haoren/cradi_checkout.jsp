...
<!-- 	購物車 -->
	...
	request.setAttribute("amountInt",amountInt);
...
// 綠界FORWORD
String lochead = "http://localhost:8081" + request.getContextPath();
System.out.println("lochead=" + lochead);


String loca = lochead + "/front-end/haoren/checkout.jsp";
        ...
        <div class="container main-contant py-5">
            ...
            <div class="form-row text-center">
                <div class="col-12 col-sm">
                    <div class="alert alert-light alert-rounded borderlen font-thick" role="alert">
                        1.付款資訊
                    </div>
                </div>
                <div class="col-12 col-sm">
                <div class="alert alert-primary alert-rounded borderlen font-thick" role="alert">
                        2.收件資訊
                    </div>
                </div>
                <div class="col-12 col-sm">
                        ...
                        <!--付款方式 -->
                            <div class="form-group col-md-6">
                                ...
                                <select class="pay form-control" name="order_pay">                                	
                                	<option value="0">信用卡已付款</option>　									
                                </select>
                                </div>
                            </div>
                            <!--付款方式 -->
                         	<!--取貨方式 -->
                            <div class="form-group col-md-6" name="delivery">
...
<!--                             郵遞區號 -->
                        ...
                        <!--便利商店 -->
                        <div class="conshop">
                         <div class="form-row" style="width: 168%;">
