...
<body>
 <table class="table table-sm text-center table table-striped " style="width:800px"  >
                                ...
                                <tbody> 
                                <c:forEach var="OrderVO" items="${List_Pay}">                             
                                    <tr>
								...
								<!-- 運送方式 -->
                                    ...
                                    <div class="modal fade" id="${OrderVO.order_id}1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
