...
<body>
 <table class="table table-sm text-center table table-striped " style="width:800px"  >
                                ...
                                <tbody> 
                                <c:forEach var="OrderVO" items="${List_Can}">                                                             
                                    <tr>
								...
								<!-- 運送方式 -->
                                        ...
                                        <td><button class="btn btn-info btn-icon-split" type="button" data-toggle="modal" data-target="#${OrderVO.order_id}3">商品資訊</button></td>
                                    </tr>
                                    

  <div class="modal fade" id="${OrderVO.order_id}3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
